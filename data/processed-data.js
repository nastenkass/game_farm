...
[
	...
	},
	{
		"title": "nextScene",
		"tags": "",
		"body": "{{sick1}}К врачу не обращалась, рецепта нет\n{{default}}[[Рецепт от врача — это всего лишь формальность. Вы можете приобрести любой препарат без рецепта, и он сработает так же хорошо|nextScene1|<<check_answer 0>>]]\n[[В таком случае я не могу вам что-то порекомендовать|nextScene1|<<check_answer 0>>]]\n[[В связи с отсутствием назначения врача, я могу Вам порекомендовать только препараты, отпускаемые без рецепта|nextScene1|<<check_answer 1>> <<point 1>>]]\n[[Не беспокойтесь, мы можем порекомендовать вам любой самый эффективный препарат без рецепта|nextScene1|<<check_answer 0>>]]",
		"position": {
			"x": 824,
			"y": 304
		},
	...
	},
	{
        "title": "nextScene4",
		"tags": "",
		"body": "{{default}} [[«Но-шпа» проявляет мощное спазмолитическое действие на гладкую мускулатуру за счет ингибирования фермента фосфодиэстеразы 4 типа.|nextScene5|<<check_answer 1>> <<point 1>>]]\n[[«Но-шпа» оказывает протеолитическое, амилолитическое и липолитическое действие.|nextScene5|<<check_answer 0>>]]",
		"position": {
			"x": 824,
			"y": 304
		},
	...
	},
	{
        "title": "nextScene6",
		"tags": "",
		"body": "{{sick1}} А «Иберогаст» как будет действовать при моих симптомах? \n {{default}}[[«Иберогаст» является специфическим блокатором дофаминовых (D2) и серотониновых рецепторов|nextScene7|<<check_answer 0>>]]\n[[«Иберогаст» нормализует тонус гладкой мускулатуры ЖКТ: способствует устранению спазма без влияния на нормальную перистальтику|nextScene7|<<check_answer 1>> <<point 1>>]]",
		"position": {
			"x": 824,
			"y": 304
		},
	...
	},
	{
        "title": "nextScene9",
		"tags": "",
		"body": "{{default}} [[Препарат принимается по 3 таблетки на один прием 1 раз/сут.|nextScene10|<<check_answer 0>>]]\n[[Препарат принимается По 1-2 таблетки на один прием 2-3 раза/сут.|nextScene10|<<check_answer 1>> <<point>>]]\n[[Препарат принимается по 1 таблетке на один прием 1 раз/сут.|nextScene10|<<check_answer 0>>]]\n[[Препарат принимается по 2-3 таблетки на один прием 2 раза/сут.|nextScene10|<<check_answer 0>>]]",
		"position": {
			"x": 824,
			"y": 304
		},
	...
	},
	{
        "title": "nextScene10",
		"tags": "",
		"body": "{{sick1}} Есть ли особенности применения в зависимости от приѐма пищи? \n {{default}} [[Препарат необходимо принимать после еды|nextScene11|<<check_answer 0>>]] \n [[Препарат необходимо принимать до еды|nextScene11|<<check_answer 0>>]] \n [[Прием препарата не зависит от приема пищи|nextScene11|<<check_answer 1>> <<point 1>>]]",
		"position": {
			"x": 824,
			"y": 304
		},
	...
	},
	{
        "title": "nextScene15",
		"tags": "",
		"body": "{{sick1}} Мне все понятно, спасибо \n {{default}} [[В таком случае предлагаю Вам оплатить препарат| |<<point 1>> <<point 0>> <<turn_on_pc 0>>]]",
		"position": {
			"x": 824,
			"y": 304
		},
